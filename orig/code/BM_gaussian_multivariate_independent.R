...
## estimation
my_model <- BM_gaussian_multivariate_independent("SBM",list(M1,M2) EXAMPLE_TEST_ARGS)
my_model$estimate()
...
## estimation
my_model <- BM_gaussian_multivariate_independent("SBM_sym",list(M1,M2) EXAMPLE_TEST_ARGS)
my_model$estimate()
which.max(my_model$ICL)
...
## estimation
my_model <- BM_gaussian_multivariate_independent("LBM",list(M1,M2) EXAMPLE_TEST_ARGS)
my_model$estimate()
which.max(my_model$ICL)
