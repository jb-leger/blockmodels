...
## estimation
my_model <- BM_bernoulli_covariates_fast("SBM",M,list(Y1,Y2) EXAMPLE_TEST_ARGS)
my_model$estimate()
...
## estimation
my_model <- BM_bernoulli_covariates_fast("SBM_sym",M,list(Y1,Y2) EXAMPLE_TEST_ARGS)
my_model$estimate()
which.max(my_model$ICL)
...
## estimation
my_model <- BM_bernoulli_covariates_fast("LBM",M,list(Y1,Y2) EXAMPLE_TEST_ARGS)
my_model$estimate()
which.max(my_model$ICL)
