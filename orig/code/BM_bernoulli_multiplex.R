...
## estimation
my_model <- BM_bernoulli_multiplex("SBM",list(M1,M2) EXAMPLE_TEST_ARGS)
my_model$estimate()
...
## estimation
my_model <- BM_bernoulli_multiplex("SBM_sym",list(M1,M2) EXAMPLE_TEST_ARGS)
my_model$estimate()
which.max(my_model$ICL)
...
## estimation
my_model <- BM_bernoulli_multiplex("LBM",list(M1,M2) EXAMPLE_TEST_ARGS)
my_model$estimate()
which.max(my_model$ICL)
